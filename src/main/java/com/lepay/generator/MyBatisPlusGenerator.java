...
public class MyBatisPlusGenerator {
    ...
    public static void main(String[] args) {
        ...
        /*
        * 切换数据库生成 pojo mapper service controller
        */
        dataSourceConfig
                .setUrl("jdbc:mysql://127.0.0.1:3306/lepay_transaction?serverTimezone=Asia/Shanghai");
        ...
        // 包名
        packageConfig.setParent("com.lepay");
        //如果需要手动输入模块名
